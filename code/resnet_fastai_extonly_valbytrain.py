...
conf_msg = '\n'.join([
                    ...
                    'External data HPAv18 validated by official train set'
                    ])
...
np.random.seed(42)
src = (ImageItemList.from_csv(src_path, '../HPAv18/HPAv18RBGY_wodpl.csv', folder='../HPAv18', suffix='.png')
